...
<body>
    ...
    <div class="kotak">
        <form action="add-lengkap-proker.php" method="post">
            <label>Nama Poker</label>
            <input type="text" name="nama_proker" class="form_login">
            <label>Dari Proker Bidang :</label>
            ...
            <button1 style="padding-right: 46%; padding-left: 45%"><a href="lengkap-proker.php">Batal</a></button1>
        </form>
